 ...
 <div class="container px-4 px-lg-5" id="home">
    ...
    <div class="d-flex">
        ...
        <div class="mt-5">
            ...
            <div class="row" id="pizza">
                ...
                <div class="col-4 mb-5">
                    <div class="card h-100" style="width: 270px">
                        ...
                        @endif
                        <!-- Product image-->
                        <img class="card-img-top" id="pizza-image" src="{{ asset('uploads/'.$item->image) }}" alt="..." height="300px" />
                        <!-- Product details-->
            ...
            @else
            <div class="alert alert-danger" role="alert" style="width: 500px; margin-top:50px">
                There is no pizza
            </div>
                @endif
            {{ $pizza->links() }}
    ...
    <div class="col-4 border shadow-sm ps-5 pt-5 pe-5 pb-2 mb-5">
        ...
        <form action="{{route('user#createContact')}}" method="post" class="my-4">
            ...
            @if ($errors->has ('name'))
             ...
             @endif
            <input type="text" name="email" value="{{old('email')}}"  value="{{old('name')}}"="" class="form-control my-3" placeholder="Email">
            @if ($errors->has ('email'))
